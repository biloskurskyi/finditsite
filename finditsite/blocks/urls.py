...
urlpatterns = [
    ...
    path('main/', login_required(MianView.as_view()), name='log_home'),

    path('log-for-common/', CommonView.as_view(), name='prog1'),
    path('common/', login_required(CommonLogView.as_view()), name='work_prog_1'),

    path('log-for-isolation/', IsolationView.as_view(), name='prog2'),
    path('isolation/', login_required(IsolationLogView.as_view()), name='work_prog_2'),

    path('log-for-detection/', DetectionView.as_view(), name='prog3'),
    path('detection/', login_required(DetectionLogView.as_view()), name='work_prog_3'),
    ...
    path('open_better_script/', views.open_better_script,
         {'script_path': '1_better.py', 'redirect_path': 'work_prog_1',
    ...
    path('open_better_script3/', views.open_better_script,
         {'script_path': '3_better.py', 'redirect_path': 'work_prog_3',
